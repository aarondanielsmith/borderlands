...
function blocksy_get_social_metadata($args = []) {
	...
	$metadata = [
		...
		'strava' => [
			...
			'icon' => '
				...
				height="20"
				viewBox="0 0 20 20">
					<path d="M12.3,13.9l-1.4-2.7h2.8L12.3,13.9z M20,3v14c0,1.7-1.3,3-3,3H3c-1.7,0-3-1.3-3-3V3c0-1.7,1.3-3,3-3h14C18.7,0,20,1.3,20,3z
	 M15.8,11.1h-2.1L9,2l-4.7,9.1H7L9,7.5l1.9,3.6H8.8l3.5,6.9L15.8,11.1z"/>
				</svg>
			'
		],
	];
	...
	if ($args['type'] === 'share') {
		...
		$social_urls = [
			...
			'viber' => 'viber://forward?{url}=This+is+the+content',
...
if (! function_exists('blockst_get_social_url_items')) {
