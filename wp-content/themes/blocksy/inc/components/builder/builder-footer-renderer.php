...
class Blocksy_Customizer_Builder_Render_Columns {
	...
	public function __construct($placements_key = 'footer_placements') {
		...
		$this->registered_items = blocksy_manager()
			->builder
			->get_registered_items_by('footer');
	}
	...
	public function get_section_value() {
		return get_theme_mod(
			$this->placements_key,
			blocksy_manager()->footer_builder->get_default_value()
		);
	}
