...
function blocksy_author_social_channels($tooltip = 'yes') {
	...
	<div class="<?php echo esc_attr($class); ?>">
		...
		<?php if ( $website ) { ?>
			<a href="<?php echo esc_url( $website ); ?>" target="_blank" rel="opener">
		...
		<?php if ( $twitter ) { ?>
			<a href="<?php echo esc_url( $twitter ); ?>" target="_blank" rel="opener">
				<svg width="20px" height="20px" viewBox="0 0 24 24">
		...
		<?php if ( $facebook ) { ?>
			<a href="<?php echo esc_url( $facebook ); ?>" target="_blank" rel="opener">
				<svg width="20px" height="20px" viewBox="0 0 24 24">
		...
		<?php if ( $linkedin ) { ?>
			<a href="<?php echo esc_url( $linkedin ); ?>" target="_blank" rel="opener">
				<svg width="20px" height="20px" viewBox="0 0 24 24">
		...
		<?php if ( $dribbble ) { ?>
			<a href="<?php echo esc_url( $dribbble ); ?>" target="_blank" rel="opener">
				<svg width="20px" height="20px" viewBox="0 0 24 24">
		...
		<?php if ( $instagram ) { ?>
			<a href="<?php echo esc_url( $instagram ); ?>" target="_blank" rel="opener">
				<svg width="20px" height="20px" viewBox="0 0 24 24">
