...
export const refreshRelatedPosts = () => {
	...
	Array.from(
		...
		() =>
			document.querySelector('.site-main .ct-related-posts[data-columns]')
				.children.length -
				1 >
				parseInt(wp.customize('related_posts_count')() || 20, 10) &&
			document
				.querySelector('.site-main .ct-related-posts[data-columns]')
				.removeChild(
					document.querySelector(
						'.site-main .ct-related-posts[data-columns]'
					).lastElementChild
				)
	)
	...
	;[
		...document.querySelectorAll(
			'.ct-related-posts[data-columns] .ct-image-container .ct-ratio'
		)
