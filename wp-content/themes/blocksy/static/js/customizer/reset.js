...
import ResetCustomizer from './components/ResetCustomizer'
...
onDocumentLoaded(() => {
	...
	render(
		<ResetCustomizer />,
		document.querySelector('#customize-header-actions .ct-revert')
	)

	document
		.querySelector('#customize-header-actions')
		.replaceChild(
			document.querySelector(
				'#customize-header-actions .ct-revert .ct-revert'
			),
			document.querySelector('#customize-header-actions .ct-revert')
		)
