...
class CatchThemesThemePlugin {
	...
	public function customize_register( $wp_customize ) {
		$wp_customize->add_section(
			new WP_Customize_Themes_Section(
				...
				'catchthemes',
				array(
					'title'      => esc_html__( 'Themes by CatchThemes', 'catch-breadcrumb' ),
					'action'     => 'catchthemes',
	...
	public function add_our_plugins_tab( $tabs ) {
		// Add our filter here
		$tabs['catchplugins'] = esc_html_x( 'Catch Plugins', 'Plugin Installer' );
	...
	public function plugins_table() {
		...
		printf(
			'<p class="catch-plugins-list">' . esc_html__( 'You can use any of our free plugins or premium plugins from <a href="%s" target="_blank">Catch Plugins</a>' ) . '.</p>',
