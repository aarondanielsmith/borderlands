...
class Plugin
{
    ...
    private  $desired_blocksy_version = '1.7.11' ;
    /**
     * Instance.
     *
    ...
    private function check_if_blocksy_is_activated()
    {
        ...
        if ( $this->is_blocksy === '__NOT_SET__' ) {
            ...
            if ( (isset( $_REQUEST['theme'] ) && strpos( $_REQUEST['theme'], 'blocksy' ) === false || isset( $_REQUEST['customize_theme'] ) && strpos( $_REQUEST['customize_theme'], 'blocksy' ) === false) && strpos( $_SERVER['REQUEST_URI'], 'customize' ) !== false ) {
    ...
    public function plugin_update()
    {
        ...
        add_action( 'admin_init', function () use( $has_beta ) {
